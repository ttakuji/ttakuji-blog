...
* [R for data science (disponível online em inglês)](https://r4ds.had.co.nz/); livro que mostra o R sendo utilizado para análise de dados. A versão em português não é disponível na internet, sendo possível só adquirir fisicamente, no entanto, a versão que tenho é preto e branco e há gráficos coloridos... 
...
* motivo:
[Por que você deve ter um blog (e escrever nele)](https://leportella.com/pt-br/porque-ter-um-blog/#desculpas-comuns-para-n%C3%A3o-escrever) e 
[https://willianjusten.com.br/como-ter-um-blog-ajuda-a-conseguir-oportunidades](https://willianjusten.com.br/como-ter-um-blog-ajuda-a-conseguir-oportunidades)

Uma pessoa com mais experiência me contou que é importante deixar registrado as atividades que faz, porque se um dia for necessário fazer algo que já fez, é mais fácil. Uma vez ele respondeu a uma pergunta em um fórum de internet explicando como faz para instalar um programa em um microprocessador. Dois anos depois, ele teve o problema, procurou na internet como fazer e quando foi realizar login na plataforma do fórum percebeu que o texto que o ajudou a resolver o problema, foi ele mesmo que tinha escrito. 
